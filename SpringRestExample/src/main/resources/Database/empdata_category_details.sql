...
CREATE TABLE `category_details` (
  ...
  `Category_desc` varchar(35) DEFAULT NULL,
...
INSERT INTO `category_details` VALUES (1,'Incident Capacity'),(2,'Problem ticket'),(3,'Service Request'),(4,'Non-Ticket'),(5,'Unproductive time'),(6,'Enhancements'),(7,'Out Of Office');
